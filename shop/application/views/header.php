...
<head>
    <title>Grocery Shopping Engine</title>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Grocery Shopping Engine" />
    <script>
    ...
    <!--//pop-up-box-->
    <!-- price range -->
    <link href="<?= base_url('assets/css/jquery-ui1.css') ?>" rel="stylesheet" type="text/css">
    <!-- fonts -->
                    ...
                    <div class="modal_body_left modal_body_left1">
                        ...
                        <form action="Signup/index" method="post">
                            ...
                            $reset = array(
                                'type'  => 'reset',
                                'value' => 'Clear Form',
                                'class'  => 'btn btn-lg reset-form btn-danger'
                            );
